...
function Row({slider, onChangeSlider, checkbox, onChangeCheckbox, switchValue, onChangeSwitch}) {
    return (
...
export function OuputForm() {
    const {sliders, setSlider, checkboxs, setCheckbox, switchs, setSwitch} = useContext(LayoutContext)
