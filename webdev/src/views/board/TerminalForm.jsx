...
export function TerminalForm () {
  ...
  const { serials, setSerials, setSerial, serialTerminator, selectSerialTerminator } = useContext( LayoutContext )
  ...
  return (
    <div className="px-4 py-2 flex flex-col gap-2 justify-between h-full">
      ...
      <div className="flex justify-between gap-4">
        <div className="grow">
          <Select options={ VALUES } selected={ serialTerminator } setSelected={ selectSerialTerminator } />
        </div>
